...
namespace QL_NhaTro
{
    public partial class NVDaNghi : Form
    {
        String Ma = "";
        public NVDaNghi()
        {
        ...
        private void NVDaNghi_Load(object sender, EventArgs e)
        {
            loadNV("");
        }
        private void loadNV(String Ten)
        {
            ...
            DataTable result = DataProvider.Instance.ExecuteQuery("SELECT * FROM nhanVien Where TenNV like N'%" + Ten + "%' and trangThai = 'false'");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Ma == "")
            {
                MessageBox.Show("Chọn Nhân Viên Trước ", "Thông Báo ");
            }
            else
            {
                ...
                {
                    int test = DataProvider.Instance.UPDATESQL("UPDATE nhanVien SET trangThai ='true' Where MaNV ='" + Ma + "'");
                    if (test == 1)
                    {
